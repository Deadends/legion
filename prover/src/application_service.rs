...
use crate::{
    auth_circuit::AuthCircuit, authentication_protocol::AuthenticationProtocol, get_timestamp,
...
impl ApplicationService {
    ...
    pub fn validate_session_with_hardware_proof(
        ...
        if let Some(session) = self.validate_session(session_id)? {
            ...
            self.webauthn
                .finish_authentication(auth_credential, state)?;
    ...
    pub fn validate_session_secure(
        &self,
        session_id: &str,
    ...
    fn default() -> Self {
        #[cfg(feature = "webauthn")]
        {
            Self::new().unwrap_or_else(|_| Self {
                ...
                rate_limiter: Arc::new(RwLock::new(HashMap::new())),
                webauthn: Arc::new(
                    crate::webauthn_service::WebAuthnService::new(
                        "localhost",
                        "http://localhost:8080",
                    )
                    .unwrap(),
